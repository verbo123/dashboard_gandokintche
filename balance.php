...
<!--                                        </div>-->
                                        ...
                                        <div class="table-data__tool">
                                            ...
                                            <div class="table-data__tool-right">
                                                ...
                                                <button id="id1" data-toggle="tooltip" data-placement="right" title="Virer votre fond issu de l'e-commerce vers votre solde total" class="badge badge-pill badge-danger" style="float: right;margin-left: 25px">Virer les fonds</button>
                                            </div>
                                        </div>

                                        <div class="table-data__tool">
                                            <div class="table-data__tool-left" >
                                                Commission actuelle <span data-toggle="tooltip" data-placement="right" title="Il s'agit du solde issu des recharges vendues"><img style="width:15px;margin-left: 20px;" src="data:image/png;base64,"> </span>
                                        </div>
                                            <div  class="table-data__tool-right">
                                                <span id="miss"><?php echo getMontantUser(getUserLogin())->montant_commission ?> FCFA</span>
                                                <button id="id2" data-toggle="tooltip" data-placement="right" title=" Virer votre fond issu de vos commissions sur recharge vers votre solde total" class="badge badge-pill badge-danger" style="float: right;margin-left: 25px">Virer les fonds</button>
                                            </div>
                                        </div>
